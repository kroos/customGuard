...
class StudentLogin extends Authenticatable implements MustVerifyEmail
{
	...
	{
		// return $this->email;
		return $this->belongstostudent->email;
	}
	...
	{
		return [$this->belongstostudent->email => $this->belongstostudent->name];
	}
	...
	public function hasVerifiedEmail()
	{
		...
		return ! is_null($this->belongstostudent->email_verified_at);
	}
	...
	{
		return $this->belongstostudent->forceFill([
